...
export default function MaleProducts() {
  ...
  const maleproducts= taskData.filter(product => product.category === 'Male');
  ...
  React.useEffect(() => {
    ...
    const uniqueCategories = [...new Set(maleproducts.map(product => product.option))];
  ...
  const applyFilters = () => {
    let filteredProducts = [...maleproducts];
  ...
  return (
    <div className='container-fluid mt-5'>
      ...
      <h2 className='text-center m-5'>Kids Products</h2>
